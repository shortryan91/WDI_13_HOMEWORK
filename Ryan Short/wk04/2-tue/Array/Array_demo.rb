...
hero = heroes[rand(heroes.length)]

# Select all elements in heroes that begin with "B" using a method.
b_grade_heroes = heroes.select do |hero|
  hero.start_with?('B')
end
...
# Print out each key-value pair in the following format - "KEY's is equal to VALUE" -- using a method. The Ruby
